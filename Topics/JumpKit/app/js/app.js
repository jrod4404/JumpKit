  ...
  document.getElementById('pageContent').innerHTML = `
    <div class="tips-grid">
      <div class="tip-card">
        ...
        <p>Click the <strong style="color:var(--hover-accent)">Configure Columns</strong> button on the <strong style="color:var(--hover-accent)">Jumps</strong> page to create up to 10 custom categories. Arrange them however you work.</p>
      </div>
      <div class="tip-card">
