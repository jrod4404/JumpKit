      ...
      membersPanel.innerHTML = members.map(m => {
        ...
        return `
          <div class="acct-row">
            ...
            <button class="btn btn-delete" data-tooltip="Remove from team" style="font-size:0.75rem;padding:3px 8px" onclick="confirmRemoveMember('${m.id}','${esc(name || email)}')"><svg class="ti ti-user-minus"><use href="img/tabler-sprite.svg#tabler-user-minus"/></svg></button>
          </div>`;
      }).join('') + inviteRows;
    }
  } catch (err) {
