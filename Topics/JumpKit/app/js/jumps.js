...
function renderColumns() {
  ...
  columns.forEach((col, colIndex) => {
    ...
    const upgradeNudge = hiddenCount > 0 ? `
      <div style="margin:4px 6px 6px;padding:7px 10px;background:rgba(80,202,204,0.06);border:1px solid rgba(80,202,204,0.18);border-radius:7px;display:flex;flex-direction:column;align-items:flex-start;gap:6px">
        <span style="font-size:0.72rem;color:var(--text-muted)">+${hiddenCount} more</span>
        <button class="btn btn-primary" style="font-size:0.72rem;padding:4px 10px;background:linear-gradient(135deg,#50CACC,#1A4FD6)" onclick="showUpgradeModal('Shared Jump Limit','Upgrade to JumpKit Core to see all shared jumps — unlimited teams, unlimited shared jumps, and unlimited launches.')">
