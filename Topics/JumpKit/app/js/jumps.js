    ...
    columns.forEach((col, colIndex) => {
      ...
      colEl.innerHTML = `
        <div class="col-header">
          ...
          <span class="col-count">${col.isShared ? `<svg class="ti ti-users" style="width:1.1em;height:1.1em;color:var(--turq);vertical-align:-0.1em;margin-right:3px;margin-top:2px"><use href="img/tabler-sprite.svg#tabler-users"/></svg>` : ''}${colJumps.length}</span>
        </div>
