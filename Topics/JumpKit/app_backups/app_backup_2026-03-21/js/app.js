...
const pageTitles = {
  ...
  stats:'Statistics', settings:'Settings', help:'Help', account:'My Account', jet:'Jet AI', feedback:'Feedback'
};
const pageIcons = {
  home:'ti-home', jumps:'ti-run', archive:'ti-archive',
  stats:'ti-chart-bar', settings:'ti-settings', help:'ti-help-circle', account:'ti-user-circle', jet:'ti-brain', feedback:'ti-message-circle'
};
let activePage = 'home';
