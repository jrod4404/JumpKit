    ...
    <div class="acct-grid">
      ...
      <div class="acct-section">
        ...
        <div class="acct-row" style="flex-wrap:wrap;gap:24px;border-bottom:none">
          ...
          <div style="text-align:center">
            <div style="font-size:0.88rem;font-weight:500;color:var(--text-muted)">${orgTeams.length}</div>
            <div style="font-size:0.72rem;color:var(--text-dim);margin-top:3px">Teams</div>
          </div>
          <div style="text-align:center">
            <div style="font-size:0.88rem;font-weight:500;color:var(--text-muted)">${orgMemberCount}</div>
            <div style="font-size:0.72rem;color:var(--text-dim);margin-top:3px">Members</div>
          </div>
          <div style="text-align:center">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;align-items:stretch">
        ...
        <div class="acct-section">
          <div class="acct-section-title" style="display:flex;align-items:center">
            ...
            <button class="btn btn-subtle" style="margin-left:auto;font-size:0.8rem;padding:3px 10px"
                    onclick="openInviteMembersModal()" id="inviteBtn" disabled>
...
window.selectTeam = async function(teamId) {
  ...
  try {
    ...
    if (members.length === 0) {
      membersPanel.innerHTML = `<p style="color:var(--text-muted);font-size:0.85rem;padding:8px 0">No members yet.</p>`;
    } else {
...
window.openAddTeamModal = function() {
  ...
  const body = `
    ...
    <div class="form-group">
      ...
      <p style="color:var(--text-muted);font-size:0.8rem;margin-top:4px">Members will use this password to join the team.</p>
...
window.saveAddTeam = async function() {
  ...
  ['atTeamNameErr', 'atTeamPasswordErr'].forEach(id => {
...
window.doRemoveTeam = async function(teamId, teamName) {
  ...
  try {
    ...
    if (selectedOrgId) selectOrg(selectedOrgId);
